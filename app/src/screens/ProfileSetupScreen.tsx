...
export default function ProfileSetupScreen({ authData, onSetupComplete }: any) {
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      // Uses the highly secure UID generated by Firebase Phone Auth
      const userData = {
        uid: authData.uid, 
      ...
      await setDoc(doc(db, 'users', authData.uid), userData);
